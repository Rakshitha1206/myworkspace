...
//model
model.addAttribute("majHeading","Shri Vishnu Engineering College for Women(SVECW)");
//view
return "index";
}
...
//Three different methods of using postMapping
//One using model.addAttribute and return view
//Other using ModelAndView predefined method
//Other using @ModelAttribute
...
if(result.hasErrors()) {
    ...
    template.postForObject("http://localhost:8080/api/v1/students",
    		requestBody,Student.class);
...
Student[] resp =template.getForObject("http://localhost:8080/api/v1/students",
Student[].class);
