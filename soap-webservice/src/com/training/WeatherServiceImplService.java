 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://sevices.training.com/", wsdlLocation = "http://localhost:5050/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://sevices.training.com/", "WeatherServiceImplService");
    ...
    public WeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://sevices.training.com/", "WeatherServiceImplPort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sevices.training.com/", "WeatherServiceImplPort"), WeatherService.class, features);
    }
